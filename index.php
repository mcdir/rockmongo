...
if (!extension_loaded("mongodb")) {
    exit("To make things right, you must install php_mongo module. <a href=\"http://fi2.php.net/manual/en/set.mongodb.php\" target=\"_blank\">Here for installation documents on PHP.net.</a>");
}
