...
<form method="post">
    ...
    <input type="checkbox" name="remove_target" value="1"
           <?php if (x("remove_target")): ?>checked="checked"<?php endif; ?>/><br/>
    <?php hm("copyindexes"); ?><br/>
    <input type="checkbox" name="copy_indexes" value="1"
           <?php if (x("copy_indexes")): ?>checked="checked"<?php endif; ?>/><br/>
