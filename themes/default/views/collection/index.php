...
<div class="operation">
    <strong><?php hm("query"); ?></strong>[<a href="<?php h($arrayLink); ?>"
                                              <?php if (x("format") == "array"): ?>style="text-decoration:underline"<?php endif; ?>>Array</a>|<a
        href="<?php h($jsonLink); ?>"
        <?php if (x("format") != "array"): ?>style="text-decoration:underline"<?php endif; ?>>JSON</a></a>]
    ...
    <form method="get" id="query_form">
        ...
        <table>
            <tr>
                ...
                <td valign="top" class="field_orders">
                    ...
                    <p><input type="text" name="field[]" value="<?php h_escape(rock_array_get(x("field"), 0)); ?>"/>
                        <select name="order[]">
                            <option value="asc"
                                    <?php if (rock_array_get(x("order"), 0) == "asc"): ?>selected="selected"<?php endif; ?>>
                                ASC
                            </option>
                            <option value="desc"
                                    <?php if (rock_array_get(x("order"), 0) == "desc"): ?>selected="selected"<?php endif; ?>>
                                DESC
                            </option>
                        </select></p>
                    <p><input type="text" name="field[]" value="<?php h_escape(rock_array_get(x("field"), 1)); ?>"/>
                        <select name="order[]">
                            <option value="asc"
                                    <?php if (rock_array_get(x("order"), 1) == "asc"): ?>selected="selected"<?php endif; ?>>
                                ASC
                            </option>
                            <option value="desc"
                                    <?php if (rock_array_get(x("order"), 1) == "desc"): ?>selected="selected"<?php endif; ?>>
                                DESC
                            </option>
                        </select></p>
                    <p><input type="text" name="field[]" value="<?php h_escape(rock_array_get(x("field"), 2)); ?>"/>
                        <select name="order[]">
                            <option value="asc"
                                    <?php if (rock_array_get(x("order"), 2) == "asc"): ?>selected="selected"<?php endif; ?>>
                                ASC
                            </option>
                            <option value="desc"
                                    <?php if (rock_array_get(x("order"), 2) == "desc"): ?>selected="selected"<?php endif; ?>>
                                DESC
                            </option>
                        </select></p>
                    <p><input type="text" name="field[]" value="<?php h_escape(rock_array_get(x("field"), 3)); ?>"/>
                        <select name="order[]">
                            <option value="asc"
                                    <?php if (rock_array_get(x("order"), 3) == "asc"): ?>selected="selected"<?php endif; ?>>
                                ASC
                            </option>
                            <option value="desc"
                                    <?php if (rock_array_get(x("order"), 3) == "desc"): ?>selected="selected"<?php endif; ?>>
                                DESC
                            </option>
                        </select></p>
                </td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <span id="fieldsAndHints"
                          <?php if (x("command") != "findAll"): ?>style="display:none"<?php endif; ?>>
			<?php if (!empty($nativeFields)): ?>
				...
				<a href="#" onclick="showQueryHints(this);return false;" title="Choose indexes will be used in query">Hints(<span
                        id="query_hints_count"><?php h(count($queryHints)); ?></span>)  <span
                        style="font-size:11px">▼</span></a> |
            <?php endif; ?>
			</span>
                    ...
                    <label id="limitLabel"
                           <?php if (x("command") != "findAll"): ?>style="display:none"<?php endif; ?>><?php hm("limit"); ?>
			...
			<?php foreach (array(10, 15, 20, 30, 50, 100, 200) as $pagesize): ?>
                <option value="<?php h($pagesize); ?>"
                        <?php if (x("pagesize") == $pagesize): ?>selected="selected"<?php endif; ?>>Rows:<?php h($pagesize); ?></option>
            <?php endforeach; ?>
			</select> |</span>
                    <?php hm("action"); ?>:
                    <select name="command" onchange="changeCommand(this)">
                        <option value="findAll"
                                <?php if (x("command") == "findAll"): ?>selected="selected"<?php endif; ?>>findAll
                        </option>
                        <option value="remove"
                                <?php if (x("command") == "remove"): ?>selected="selected"<?php endif; ?>>remove
                        </option>
                        <option value="modify"
                                <?php if (x("command") == "modify"): ?>selected="selected"<?php endif; ?>>modify
                        </option>
                    </select>
                </td>
            </tr>
        ...
        <div id="query_fields_list" class="fieldsmenu">
            <div align="right" style="padding-right:10px;background:#999"><a href="#"
                                                                             onclick="closeQueryFields();return false;"
            ...
            <ul>
                <?php foreach ($indexFields as $index => $field): ?>
                    <li title="<?php h(htmlspecialchars($field["keystring"])); ?>"><label><input type="checkbox"
                                                                                                 ...
                                                                                                 value="<?php h($field["name"]); ?>"
                                                                                                 <?php if (in_array($field["name"], $queryHints)): ?>checked="checked"<?php endif; ?>
    ...
    <?php else: ?>
        ...
        <?php foreach ($rows as $index => $row): ?>
            <div style="border:2px #ccc solid;margin-bottom:5px;"
                 onmouseover="showOperationButtons('<?php h($index); ?>')"
                 onmouseout="hideOperationButtons('<?php h($index); ?>')" class="record"
                 <?php if (MCollection::isFile($row)): ?>r-is-file="yes"
                 r-file-name="<?php h($row["filename"]) ?>"<?php endif; ?>>
                            ...
                            <div class="operation" id="operate_<?php h($index); ?>">
                                ...
                                <?php else: ?>
                                    <a href="#" class="disabled"
                                       onclick="return false;"><?php echo hm("delete"); ?></a> |
                                <?php endif; ?>
                                ...
                                <?php else: ?>
                                    <a href="#" class="disabled"
                                       onclick="return false;"><?php echo hm("new_field"); ?></a> |
                                <?php endif; ?>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php render_select_data_types("data_type", "string"); ?> <select name="format"
                                                                                  ...
                                                                                  style="display:none">
                    <option value="array" <?php if ($last_format == "array"): ?>selected="selected"<?php endif; ?>>
                        Array
                    </option>
