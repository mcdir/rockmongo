...
<form method="post">
            ...
            <?php else: ?>
                <?php foreach ($collections as $collection): ?>
                    <li><label><input type="checkbox" class="check_collection"
                                      name="checked[<?php h($collection->getName()); ?>]" value="1"
                                      <?php if (in_array($collection->getName(), $selectedCollections)): ?>checked="checked"<?php endif; ?>/> <?php h($collection->getName()); ?>
                        </label></li>
                <?php endforeach; ?>
            <?php endif; ?>
        </ul>
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="target_auth"
                           <?php if ($target_auth == 1): ?>checked="checked"<?php endif; ?> value="1"/></td>
            </tr>
            <tr>
    ...
    <div>
        ...
        <?php hm("copyindexes"); ?> <input type="checkbox" name="copy_indexes" value="1"
                                           <?php if (x("copy_indexes")): ?>checked="checked"<?php endif; ?>/>
        <br/><br/>
    </div>
    <div>
