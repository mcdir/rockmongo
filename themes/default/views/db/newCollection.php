...
<form method="post">
    <table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="400">
        ...
        <tr bgcolor="#ffffff">
            ...
            <td><input type="checkbox" name="is_capped" value="1"
                       <?php if ($isCapped): ?>checked="checked"<?php endif; ?> /></td>
        </tr>
        <tr bgcolor="#ffffff">
            <td><?php hm("size"); ?></td>
...
<p><a href="http://docs.mongodb.org/manual/reference/method/db.createCollection/" target="_blank">Here for more
        details &raquo;</a></p>
