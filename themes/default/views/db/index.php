...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
    <tr>
        <td colspan="2" style="text-align:center;font-weight:bold"><a
                href="http://docs.mongodb.org/manual/reference/command/dbStats/#dbcmd.dbStats" target="_blank">Database
                Statistics</a> ({dbStats:1})
        </td>
    </tr>
