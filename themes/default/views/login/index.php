...
<div style="padding:10px;margin:200px auto;width:300px;border:1px #ccc solid">
    ...
    <form method="post">
        ...
        <table>
            ...
            <tr>
                <td colspan="2"><a href="#" onclick="return r_show_more_options(this)"
            ...
            <tr>
                ...
                <td><select name="lang" style="width:150px">
                        <?php foreach ($languages as $code => $lang): ?>
                            <option value="<?php h($code); ?>"
                                    <?php if (x("lang") == $code || (x("lang") == "" && __LANG__ == $code)): ?>selected="selected"<?php endif; ?> ><?php h($lang); ?></option>
                        <?php endforeach; ?>
                    </select></td>
            </tr>
            <tr>
